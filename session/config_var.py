...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/f46b11140c307df13750d.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TeamSpeedo/Speedo"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/f46b11140c307df13750d.jpg"
    )
    U_BRANCH = "master"
